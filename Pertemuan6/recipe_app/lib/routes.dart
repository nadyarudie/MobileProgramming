...
import 'screens/detail_page.dart'; // <-- Import ini sekarang akan terpakai
import 'screens/login_page.dart';
import 'screens/profile_page.dart'; // <-- 1. Tambahkan import untuk ProfilePage
...
class AppRoutes {
  ...
  static const String profile = '/profile'; // <-- 2. Tambahkan rute profile
}
...
class AppRouter {
  static Route<dynamic>? onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.detail:
        ...
        if (args is Recipe) {
          return MaterialPageRoute(
            ...
            // ✅ 3. PERBAIKAN BUG: Harusnya 'RecipeDetailPage' bukan 'AppRoutes.DetailPage'
      ...
      // ✅ 4. Tambahkan case untuk rute profile
